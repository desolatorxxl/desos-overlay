...
DESCRIPTION="A modern load testing tool for developers and testers in the DevOps era."
...
EGO_SUM=(
	...
	"github.com/DataDog/datadog-go v0.0.0-20180330214955-e67964b4021a/go.mod"
	"github.com/OneOfOne/xxhash v1.2.2/go.mod"
	"github.com/PuerkitoBio/goquery v1.6.1"
	"github.com/PuerkitoBio/goquery v1.6.1/go.mod"
	"github.com/Soontao/goHttpDigestClient v0.0.0-20170320082612-6d28bb1415c5"
	"github.com/Soontao/goHttpDigestClient v0.0.0-20170320082612-6d28bb1415c5/go.mod"
	...
	"github.com/gedex/inflector v0.0.0-20170307190818-16278e9db813/go.mod"
	...
	"github.com/influxdata/influxdb1-client v0.0.0-20190402204710-8ff2fc3824fc/go.mod"
	"github.com/jhump/protoreflect v1.10.0"
	"github.com/jhump/protoreflect v1.10.0/go.mod"
	...
	"github.com/kubernetes/helm v2.9.0+incompatible/go.mod"
	...
	"github.com/manyminds/api2go v0.0.0-20180125085803-95be7bd0455e/go.mod"
	...
	"github.com/mccutchen/go-httpbin v1.1.2-0.20190116014521-c5cb2f4802fa/go.mod"
	...
	"golang.org/x/net v0.0.0-20211101194204-95aca89e93de/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20200903010400-9bfcb5116336/go.mod"
	...
	"gopkg.in/guregu/null.v2 v2.1.2/go.mod"
...
SRC_URI="https://github.com/grafana/k6/archive/refs/tags/v${PV}.tar.gz -> k6-${PV}.tar.gz
	${EGO_SUM_SRC_URI}"

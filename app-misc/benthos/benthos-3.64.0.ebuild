...
EGO_SUM=(
	...
	"github.com/99designs/keyring v1.2.0/go.mod"
	"github.com/AthenZ/athenz v1.10.15/go.mod"
	"github.com/AthenZ/athenz v1.10.43"
	"github.com/AthenZ/athenz v1.10.43/go.mod"
	...
	"github.com/Azure/azure-sdk-for-go v61.1.0+incompatible/go.mod"
	"github.com/Azure/azure-storage-blob-go v0.14.0/go.mod"
	"github.com/Azure/azure-storage-queue-go v0.0.0-20191125232315-636801874cdd"
	"github.com/Azure/azure-storage-queue-go v0.0.0-20191125232315-636801874cdd/go.mod"
	"github.com/Azure/go-amqp v0.17.0"
	"github.com/Azure/go-amqp v0.17.0/go.mod"
	...
	"github.com/Azure/go-autorest/autorest v0.11.23/go.mod"
	...
	"github.com/DataDog/zstd v1.4.6-0.20210211175136-c6db21d202f4/go.mod"
	...
	"github.com/Jeffail/grok v1.1.0/go.mod"
	...
	"github.com/Shopify/sarama v1.30.1/go.mod"
	...
	"github.com/apache/pulsar-client-go v0.7.0/go.mod"
	"github.com/apache/pulsar-client-go/oauth2 v0.0.0-20201120111947-b8bd55bc02bd/go.mod"
	"github.com/apache/pulsar-client-go/oauth2 v0.0.0-20220210221528-5daa17b02bff"
	"github.com/apache/pulsar-client-go/oauth2 v0.0.0-20220210221528-5daa17b02bff/go.mod"
	...
	"github.com/aws/aws-lambda-go v1.28.0/go.mod"
	"github.com/aws/aws-sdk-go v1.19.38/go.mod"
	"github.com/aws/aws-sdk-go v1.30.19/go.mod"
	"github.com/aws/aws-sdk-go v1.32.6/go.mod"
	"github.com/aws/aws-sdk-go v1.42.23/go.mod"
	"github.com/aws/aws-sdk-go v1.42.31"
	"github.com/aws/aws-sdk-go v1.42.31/go.mod"
	...
	"github.com/benhoyt/goawk v1.13.0/go.mod"
	...
	"github.com/colinmarc/hdfs v1.1.3/go.mod"
	...
	"github.com/gdamore/optopia v0.2.0/go.mod"
	...
	"github.com/gocql/gocql v0.0.0-20211222173705-d73e6b1002a7/go.mod"
	...
	"github.com/influxdata/go-syslog/v3 v3.0.0/go.mod"
	...
	"github.com/jhump/protoreflect v1.10.1/go.mod"
	...
	"github.com/linkedin/goavro/v2 v2.11.0/go.mod"
	...
	"github.com/nats-io/nats-server/v2 v2.7.2/go.mod"
	"github.com/nats-io/nats-streaming-server v0.24.1"
	"github.com/nats-io/nats-streaming-server v0.24.1/go.mod"
	"github.com/nats-io/nats.go v1.13.0/go.mod"
	"github.com/nats-io/nats.go v1.13.1-0.20220121202836-972a071d373d"
	"github.com/nats-io/nats.go v1.13.1-0.20220121202836-972a071d373d/go.mod"
	...
	"github.com/olivere/elastic/v7 v7.0.31/go.mod"
	...
	"github.com/ory/dockertest/v3 v3.8.1/go.mod"
	...
	"github.com/patrobinson/gokini v0.1.0/go.mod"
	"github.com/pborman/getopt v0.0.0-20180729010549-6fdd0a2c7117/go.mod"
	"github.com/pebbe/zmq4 v1.2.7"
	"github.com/pebbe/zmq4 v1.2.7/go.mod"
	...
	"github.com/prometheus/common v0.0.0-20181116084131-1f2c4f3cd6db/go.mod"
	...
	"github.com/quipo/dependencysolver v0.0.0-20170801134659-2b009cb4ddcc/go.mod"
	"github.com/quipo/statsd v0.0.0-20180118161217-3d6a5565f314"
	"github.com/quipo/statsd v0.0.0-20180118161217-3d6a5565f314/go.mod"
	"github.com/rabbitmq/amqp091-go v1.2.0"
	"github.com/rabbitmq/amqp091-go v1.2.0/go.mod"
	"github.com/rcrowley/go-metrics v0.0.0-20201227073835-cf1acfcdf475"
	"github.com/rcrowley/go-metrics v0.0.0-20201227073835-cf1acfcdf475/go.mod"
	"github.com/rickb777/date v1.17.0"
	"github.com/rickb777/date v1.17.0/go.mod"
	"github.com/rickb777/plural v1.4.1"
	"github.com/rickb777/plural v1.4.1/go.mod"
	...
	"github.com/smira/go-statsd v1.3.2/go.mod"
	...
	"github.com/tilinna/z85 v1.0.0/go.mod"
	"github.com/tmc/grpc-websocket-proxy v0.0.0-20190109142713-0ad062ec5ee5/go.mod"
	"github.com/trivago/grok v1.0.0"
	"github.com/trivago/grok v1.0.0/go.mod"
	"github.com/trivago/tgo v1.0.7"
	"github.com/trivago/tgo v1.0.7/go.mod"
	...
	"github.com/twmb/franz-go v1.3.1/go.mod"
	"github.com/twmb/franz-go/pkg/kmsg v0.0.0-20211127185622-3b34db0c6d1e/go.mod"
	"github.com/twmb/franz-go/pkg/kmsg v0.0.0-20220106200407-cfd3330d96f5"
	"github.com/twmb/franz-go/pkg/kmsg v0.0.0-20220106200407-cfd3330d96f5/go.mod"
	...
	"github.com/xitongsys/parquet-go-source v0.0.0-20211228015320-b4f792c43cd0/go.mod"
	...
	"go.mongodb.org/mongo-driver v1.8.2/go.mod"
	"go.nanomsg.org/mangos/v3 v3.3.0"
	"go.nanomsg.org/mangos/v3 v3.3.0/go.mod"
...
SRC_URI="https://github.com/Jeffail/benthos/archive/refs/tags/v${PV}.tar.gz -> ${P}-${PV}.tar.gz
	${EGO_SUM_SRC_URI}"

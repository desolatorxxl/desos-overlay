...
EGO_SUM=(
	...
	"github.com/lithammer/shortuuid v3.0.0+incompatible/go.mod"
	...
	"github.com/yannh/kubeconform v0.4.8/go.mod"
...
SRC_URI="https://github.com/datreeio/datree/archive/refs/tags/$PV.tar.gz -> datree-$PV.tar.gz
	$EGO_SUM_SRC_URI"
